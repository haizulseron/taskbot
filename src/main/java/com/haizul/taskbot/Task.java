...
public class Task {
    ...
    private Integer reminderIntervalMinutes;  // null = use priority default
    private boolean repeatReminder;           // keep reminding after due
    ...
    /** Default reminder interval in minutes based on priority */
